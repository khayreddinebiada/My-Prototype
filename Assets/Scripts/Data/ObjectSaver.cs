...
namespace data
{
    public class ObjectSaver
    {
        ...
        public static void OnModifyValue<TObject,TParameter>(TObject currentObject, ref TParameter lastValue, TParameter newValue, SaveType saveType = SaveType.PlayerPrefab, string instanceID = "")
        {
            if (!lastValue.Equals(newValue))
            {
                Debug.Log("Is not the same");
                lastValue = newValue;
                SaveObject(currentObject, saveType, instanceID);
            }
        }
